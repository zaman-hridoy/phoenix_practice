defmodule Hello.CatalogTest do
  ...
  describe "products" do
    ...
    @invalid_attrs %{"": nil, description: nil, title: nil, price: nil, views: nil}
    ...
    test "create_product/1 with valid data creates a product" do
      valid_attrs = %{"": 42, description: "some description", title: "some title", price: "some price", views: "some views"}
      ...
      assert product.views == "some views"
    end
    ...
    test "update_product/2 with valid data updates the product" do
      product = product_fixture()
      update_attrs = %{"": 43, description: "some updated description", title: "some updated title", price: "some updated price", views: "some updated views"}
      ...
      assert product.views == "some updated views"
    end
